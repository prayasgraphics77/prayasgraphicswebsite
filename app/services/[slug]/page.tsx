    ...
    <main className="flex min-h-screen flex-col items-center bg-stone-50 pb-20 pt-24 overflow-x-hidden">
          ...
          <div className="order-2 lg:order-1 flex flex-col items-start">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <Link
                ...
                className="w-full sm:w-auto flex h-14 items-center justify-center rounded-full bg-[#800080] px-8 font-semibold text-white transition-all hover:bg-[#800080]/90 hover:scale-[1.02] shadow-lg shadow-[#800080]/20"
              >
          ...
          <div className="rounded-[24px] bg-white p-8 shadow-sm border border-zinc-100">
            ...
            <ul className="space-y-3">
              {service.materials.map((material, idx) => (
                <li key={idx} className="flex items-start gap-3">
                  <div className="h-2 w-2 rounded-full bg-[#800080]/60 shrink-0 mt-2" />
      ...
      <section className="w-full max-w-7xl px-4 md:px-6 relative">
        <div className="rounded-[32px] bg-zinc-950 px-8 py-16 text-center text-white md:p-20 relative overflow-hidden flex flex-col items-center">
            ...
            <div className="absolute -top-24 -right-24 h-64 w-64 rounded-full bg-[#800080]/20 blur-[80px]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {otherServices.map((relatedService) => (
            <Link href={`/services/${relatedService.slug}`} key={relatedService.slug}>
              <div className="group flex flex-col justify-between rounded-[20px] bg-white p-6 shadow-sm border border-zinc-100 transition-all hover:shadow-md hover:border-[#800080]/30">
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex relative h-12 w-12 items-center justify-center rounded-xl bg-[#800080]/5 text-[#800080] group-hover:bg-[#800080] group-hover:text-white transition-colors">
                    <relatedService.icon className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="font-heading font-bold text-zinc-900 group-hover:text-[#800080] transition-colors">{relatedService.title}</h4>
                  </div>
                </div>
