      ...
      >
        <div className="flex flex-col gap-6">
          <div className="max-w-md pt-12 md:pt-24">
            ...
            {/* Social Logos for Mobile (under text) */}
            <div className="mt-8 flex items-center gap-3 sm:hidden">
              <a href="https://g.page/r/CbL_ssLkBR47EAI/review" target="_blank" rel="noopener noreferrer" aria-label="Review us on Google"
                className="group flex h-10 w-10 items-center justify-center rounded-full bg-zinc-100 text-zinc-500 transition-all duration-200 active:bg-[#4285F4] active:text-white">
              ...
              <a href="https://www.instagram.com/prayas_graphics_77/" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram"
                className="group flex h-10 w-10 items-center justify-center rounded-full bg-zinc-100 text-zinc-500 transition-all duration-200 active:bg-linear-to-br active:from-purple-500 active:via-pink-500 active:to-orange-400 active:text-white">
                <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
              ...
              <a href="https://www.facebook.com/prayasgraphics/" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook"
                className="group flex h-10 w-10 items-center justify-center rounded-full bg-zinc-100 text-zinc-500 transition-all duration-200 active:bg-[#1877F2] active:text-white">
                <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
        ...
        <div className="mt-12 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 rounded-full border border-zinc-200 bg-zinc-50/50 px-3.5 py-1.5 text-xs text-zinc-500 font-medium transition-all hover:border-zinc-300 hover:bg-zinc-50 shadow-xs">
              Powered by <a href="https://intrface.in" target="_blank" rel="noopener noreferrer" className="font-bold text-zinc-950 hover:underline decoration-zinc-300 underline-offset-2">intrface</a>
            </div>
